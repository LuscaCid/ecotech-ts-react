...
export function Login() {
    ...
    <div className=" bg-zinc-900  m-auto w-fit mt-20">
        <div className=" rounded-lg bg-zinc-800 flex  justify-between w-[1000px] shadow-lg">
            <form className="w-1/2 h-full flex flex-col gap-4 p-5  rounded-l-lg bg-zinc-800">
            ...
            <aside className="relative bg-gradient-to-l border-l border-zinc-700 p-5 w-1/2 h-full  from-green-500">
                <h1 className="text-white text-6xl border-b-1 w-fit border-white pb-1 mb-4">W5I</h1>
                <img className="image w-24 absolute bottom-4 right-4" src="../../assets/login-aside.svg" alt="" />
            </aside>
        </div>
    </div>  
    </>
